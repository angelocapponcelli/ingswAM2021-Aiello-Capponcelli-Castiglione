...
import it.polimi.ingsw.server.model.FinalCell;
import it.polimi.ingsw.server.model.PopeSpaceCell;
import it.polimi.ingsw.server.model.VaticanReportSection;
...
public class FaithTrackParser {
    ...
    private List<Cell> track = new ArrayList<>();
    private List<VaticanReportSection> reportSections = new ArrayList<>();
